...
describe('RecipeRepository', () => {
  let recipe, recipeInfo, ingredientInfo, user, userInfo, recipeRepository;
  ...
  it('should be able to filter recipes by tag', () => {
    ...
    expect(recipeRepository.filterRecipesByTag('antipasti')).to.deep.equal([{
  ...
  it('should be able to search recipes by name', () => {
    user.saveRecipe(recipe);
    expect(recipeRepository.filterRecipesByIngredient('Chicken Parm')).to.deep.equal([recipe]);
  });
})
